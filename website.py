...
class Twinby(DatingWebsite):
    ...
    def __init__(self, account, web_driver = None):
        ...
        super().__init__("Twinby", "https://twinby.com/", account, web_driver)
    ...
    def login(self):
        ...
        self.click_button("//button[@class='login2024-actions-link']")
...
class Mamba(DatingWebsite):
    ...
    def __init__(self, account, web_driver = None):
        ...
        super().__init__("Mamba", "https://www.mamba.ru/", account, web_driver)
...
class Vk(DatingWebsite):
    ...
    def __init__(self, account, web_driver = None):
        """Initializes Tinder class with name, url, account, and web_driver."""
        super().__init__("Twinby", "https://vk.com/", account, web_driver)
